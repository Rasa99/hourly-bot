...
**Updated 2026-09-08 08:07 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
| | |
|---|---|
| **Equity now** | **$20.4084** 🟢 +2.04% |
| Settled balance | $20.4539 (+2.27%) |
| Unrealised (open trades) | 🔴 -0.0455 |
...
|---|---|---|---|---|---|---|---|
| **DOT** | LONG 🔺 | 1.069 | 1.059 | -0.94% | 🔴 -0.0455 | -10.6% | 2.83% |
| | | | | **total** | **-0.0455** | | |
...
|---|---|---|---|
| CHZ | LONG | 0.98% | needs 1.0% move; trend too weak (ADX 12/20) |
| APE | LONG | 0.99% | needs 1.0% move; trend too weak (ADX 9/20) |
| SKL | LONG | 1.02% | needs 1.0% move; volume below average |
| ETC | LONG | 1.09% | needs 1.1% move |
| QTUM | LONG | 1.26% | needs 1.3% move; trend too weak (ADX 13/20) |
| COMP | LONG | 1.41% | needs 1.4% move; trend too weak (ADX 12/20) |
| BAT | LONG | 1.49% | needs 1.5% move; trend too weak (ADX 14/20) |
| AVAX | LONG | 1.72% | needs 1.7% move; volume below average |
| SAND | LONG | 1.75% | needs 1.7% move; trend too weak (ADX 9/20) |
| IOTA | LONG | 2.11% | needs 2.1% move; trend too weak (ADX 12/20) |
