...
**Updated 2026-09-26 02:07 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
| | |
|---|---|
| **Equity now** | **$20.4560** 🟢 +2.28% |
| Settled balance | $20.4136 (+2.07%) |
| Unrealised (open trades) | 🟢 +0.0423 |
...
|---|---|---|---|---|---|---|---|
| **MANA** | LONG 🔺 | 0.09099 | 0.09164 | +0.71% | 🟢 +0.0423 | +5.8% | 3.46% |
| | | | | **total** | **+0.0423** | | |
...
| ADA | LONG | 0.08% | needs 0.1% move |
| SOL | LONG | 0.73% | needs 0.7% move |
| AAVE | LONG | 0.88% | needs 0.9% move; volume below average |
| IOTA | LONG | 1.09% | needs 1.1% move |
| COMP | LONG | 1.20% | needs 1.2% move; volume below average |
| EGLD | LONG | 1.26% | needs 1.3% move; volume below average |
| KSM | LONG | 1.27% | needs 1.3% move; volume below average |
| GALA | LONG | 1.53% | needs 1.5% move; volume below average |
