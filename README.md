...
**Updated 2026-09-12 04:09 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
|---|---|---|---|
| CHZ | LONG | 0.00% | **READY** |
| LTC | LONG | 1.43% | needs 1.4% move; trend too weak (ADX 17/20) |
| HBAR | SHORT | 1.61% | needs 1.6% move; volume below average |
| CRV | SHORT | 1.61% | needs 1.6% move; trend too weak (ADX 16/20) |
| BTC | SHORT | 1.71% | needs 1.7% move; trend too weak (ADX 16/20) |
| LINK | SHORT | 1.92% | needs 1.9% move; trend too weak (ADX 20/20) |
| COMP | SHORT | 2.01% | needs 2.0% move; trend too weak (ADX 13/20) |
| AVAX | SHORT | 2.35% | needs 2.3% move; volume below average |
| RVN | SHORT | 2.64% | needs 2.6% move |
| DOGE | SHORT | 2.70% | needs 2.7% move; volume below average |
