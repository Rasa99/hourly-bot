...
**Updated 2026-09-12 03:07 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
|---|---|---|---|
| CHZ | LONG | 0.00% | trend too weak (ADX 18/20) |
| CRV | SHORT | 1.40% | needs 1.4% move; trend too weak (ADX 16/20) |
| LTC | LONG | 1.41% | needs 1.4% move; trend too weak (ADX 18/20) |
| HBAR | SHORT | 1.70% | needs 1.7% move; volume below average |
| BTC | SHORT | 1.71% | needs 1.7% move; trend too weak (ADX 17/20) |
| COMP | SHORT | 2.10% | needs 2.1% move; trend too weak (ADX 13/20) |
| LINK | SHORT | 2.18% | needs 2.2% move; volume below average |
| AVAX | SHORT | 2.40% | needs 2.4% move; volume below average |
| BAT | SHORT | 2.74% | needs 2.7% move; volume below average |
| DOGE | SHORT | 2.75% | needs 2.7% move; volume below average |
