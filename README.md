...
**Updated 2026-09-07 20:07 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
| | |
|---|---|
| **Equity now** | **$20.3652** 🟢 +1.83% |
| Settled balance | $20.4539 (+2.27%) |
| Unrealised (open trades) | 🔴 -0.0887 |
...
|---|---|---|---|---|---|---|---|
| **DOT** | LONG 🔺 | 1.069 | 1.048 | -1.96% | 🔴 -0.0887 | -20.7% | 1.81% |
| | | | | **total** | **-0.0887** | | |
...
|---|---|---|---|
| COMP | LONG | 0.66% | needs 0.7% move; trend too weak (ADX 18/20) |
| HBAR | LONG | 0.84% | needs 0.8% move; trend too weak (ADX 15/20) |
| BAT | LONG | 1.14% | needs 1.1% move; trend too weak (ADX 17/20) |
| QTUM | LONG | 1.19% | needs 1.2% move; trend too weak (ADX 12/20) |
| AVAX | LONG | 1.20% | needs 1.2% move; volume below average |
| SAND | LONG | 1.25% | needs 1.3% move; trend too weak (ADX 13/20) |
| SKL | LONG | 1.28% | needs 1.3% move; volume below average |
| APE | LONG | 1.31% | needs 1.3% move; trend too weak (ADX 11/20) |
| ONT | LONG | 1.53% | needs 1.5% move; trend too weak (ADX 14/20) |
| BTC | LONG | 1.55% | needs 1.5% move; volume below average |
