...
**Updated 2026-09-20 06:09 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
|---|---|---|---|
| ONT | LONG | 0.33% | needs 0.3% move |
| EGLD | SHORT | 0.97% | needs 1.0% move; volume below average |
| BTC | LONG | 1.81% | needs 1.8% move; volume below average |
| GRT | LONG | 1.98% | needs 2.0% move |
| ENJ | LONG | 2.22% | needs 2.2% move; trend too weak (ADX 20/20) |
| BAT | LONG | 2.26% | needs 2.3% move |
| QTUM | LONG | 2.32% | needs 2.3% move; trend too weak (ADX 19/20) |
| MANA | LONG | 2.99% | needs 3.0% move; volume below average |
| BNB | LONG | 3.03% | needs 3.0% move; volume below average |
| SNX | LONG | 3.28% | needs 3.3% move; volume below average |
