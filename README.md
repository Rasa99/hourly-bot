...
**Updated 2026-09-07 22:07 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
| | |
|---|---|
| **Equity now** | **$20.4372** 🟢 +2.19% |
| Settled balance | $20.4539 (+2.27%) |
| Unrealised (open trades) | 🔴 -0.0167 |
...
|---|---|---|---|---|---|---|---|
| **DOT** | LONG 🔺 | 1.069 | 1.066 | -0.28% | 🔴 -0.0167 | -3.9% | 3.47% |
| | | | | **total** | **-0.0167** | | |
...
|---|---|---|---|
| APE | LONG | 0.14% | needs 0.1% move; trend too weak (ADX 12/20) |
| BAT | LONG | 0.25% | needs 0.3% move; trend too weak (ADX 17/20) |
| COMP | LONG | 0.37% | needs 0.4% move; trend too weak (ADX 18/20) |
| HBAR | LONG | 0.86% | needs 0.9% move; trend too weak (ADX 14/20) |
| QTUM | LONG | 0.95% | needs 1.0% move; trend too weak (ADX 11/20) |
| IOTA | LONG | 1.01% | needs 1.0% move; trend too weak (ADX 15/20) |
| AVAX | LONG | 1.17% | needs 1.2% move; volume below average |
| SKL | LONG | 1.28% | needs 1.3% move; volume below average |
| AXS | LONG | 1.51% | needs 1.5% move; trend too weak (ADX 13/20) |
| ETC | LONG | 1.65% | needs 1.7% move; trend too weak (ADX 16/20) |
