...
**Updated 2026-09-01 23:07 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
|---|---|---|---|
| DOGE | SHORT | 0.95% | needs 0.9% move; volume below average |
| BNB | SHORT | 1.01% | needs 1.0% move; volume below average |
| HBAR | SHORT | 1.34% | needs 1.3% move; trend too weak (ADX 18/20) |
| LRC | SHORT | 1.39% | needs 1.4% move; volume below average |
| ATOM | SHORT | 1.44% | needs 1.4% move |
| EGLD | LONG | 1.46% | needs 1.5% move; trend too weak (ADX 12/20) |
| CELO | SHORT | 1.49% | needs 1.5% move; volume below average |
| ANKR | SHORT | 1.56% | needs 1.6% move; volume below average |
| GRT | SHORT | 1.92% | needs 1.9% move; trend too weak (ADX 17/20) |
| IOTA | SHORT | 1.93% | needs 1.9% move; trend too weak (ADX 16/20) |
