...
**Updated 2026-09-25 17:07 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
| | |
|---|---|
| **Equity now** | **$20.4806** 🟢 +2.40% |
| Settled balance | $20.4136 (+2.07%) |
| Unrealised (open trades) | 🟢 +0.0670 |
...
|---|---|---|---|---|---|---|---|
| **MANA** | LONG 🔺 | 0.09099 | 0.09194 | +1.04% | 🟢 +0.0670 | +9.2% | 3.77% |
| | | | | **total** | **+0.0670** | | |
...
|---|---|---|---|
| SOL | LONG | 1.18% | needs 1.2% move |
| KSM | LONG | 1.27% | needs 1.3% move |
| MANA | LONG | 1.31% | needs 1.3% move; volume below average |
| QTUM | LONG | 1.35% | needs 1.3% move; volume below average |
| AAVE | LONG | 1.50% | needs 1.5% move |
| ONT | LONG | 1.65% | needs 1.7% move; volume below average |
| SKL | LONG | 1.97% | needs 2.0% move |
| EGLD | LONG | 2.15% | needs 2.1% move; volume below average |
| COMP | LONG | 2.26% | needs 2.3% move; volume below average |
| IOTA | LONG | 2.37% | needs 2.4% move |
