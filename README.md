...
**Updated 2026-09-02 16:07 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
| | |
|---|---|
| **Equity now** | **$18.7366** 🔴 -6.32% |
| Settled balance | $18.4605 (-7.70%) |
| Unrealised (open trades) | 🟢 +0.2762 |
...
|---|---|---|---|---|---|---|---|
| **EGLD** | LONG 🔺 | 4.334 | 4.566 | +5.35% | 🟢 +0.2762 | +53.1% | 8.30% |
| | | | | **total** | **+0.2762** | | |
...
|---|---|---|---|
| EGLD | LONG | 0.47% | needs 0.5% move; RSI already stretched (79/78) |
| HBAR | SHORT | 0.86% | needs 0.9% move; volume below average |
| ALGO | LONG | 1.19% | needs 1.2% move; trend too weak (ADX 13/20) |
| SKL | SHORT | 1.38% | needs 1.4% move |
| ETH | SHORT | 1.46% | needs 1.5% move |
| CELO | LONG | 1.48% | needs 1.5% move; volume below average |
| BCH | SHORT | 1.49% | needs 1.5% move; trend too weak (ADX 18/20) |
| ATOM | SHORT | 1.58% | needs 1.6% move; volume below average |
| LINK | SHORT | 1.65% | needs 1.7% move; volume below average |
| DOGE | SHORT | 1.87% | needs 1.9% move |
