...
**Updated 2026-09-12 06:07 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
|---|---|---|---|
| CRV | SHORT | 0.87% | needs 0.9% move; trend too weak (ADX 14/20) |
| HBAR | SHORT | 1.23% | needs 1.2% move; volume below average |
| BTC | SHORT | 1.63% | needs 1.6% move; trend too weak (ADX 14/20) |
| LTC | LONG | 1.77% | needs 1.8% move; trend too weak (ADX 15/20) |
| COMP | SHORT | 2.10% | needs 2.1% move; trend too weak (ADX 13/20) |
| LINK | SHORT | 2.16% | needs 2.2% move; trend too weak (ADX 18/20) |
| AVAX | SHORT | 2.18% | needs 2.2% move; volume below average |
| RVN | SHORT | 2.28% | needs 2.3% move; volume below average |
| QTUM | LONG | 2.51% | needs 2.5% move; volume below average |
| DOGE | SHORT | 2.67% | needs 2.7% move; volume below average |
