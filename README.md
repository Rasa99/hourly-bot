...
**Updated 2026-08-31 08:07 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
| | |
|---|---|
| **Equity now** | **$19.2402** 🔴 -3.80% |
| Settled balance | $18.8169 (-5.92%) |
| Unrealised (open trades) | 🟢 +0.4233 |
...
|---|---|---|---|---|---|---|---|
| **FIL** | SHORT 🔻 | 0.6813 | 0.6736 | -1.13% | 🟢 +0.0733 | +10.3% | 3.89% |
| **SAND** | SHORT 🔻 | 0.03898 | 0.03663 | -6.03% | 🟢 +0.3500 | +49.9% | 7.73% |
| | | | | **total** | **+0.4233** | | |
...
| EGLD | LONG | 1.40% | needs 1.4% move; volume below average |
| STORJ | SHORT | 1.42% | needs 1.4% move; volume below average |
| HBAR | SHORT | 2.04% | needs 2.0% move; volume below average |
| BTC | LONG | 2.17% | needs 2.2% move; volume below average |
| ANKR | LONG | 2.24% | needs 2.2% move |
| DOGE | SHORT | 2.32% | needs 2.3% move; volume below average |
| ETC | SHORT | 2.41% | needs 2.4% move; volume below average |
| ALGO | SHORT | 2.43% | needs 2.4% move; volume below average |
| LTC | SHORT | 2.51% | needs 2.5% move; volume below average |
