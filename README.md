...
**Updated 2026-09-13 13:07 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
|---|---|---|---|
| FIL | LONG | 0.00% | trend too weak (ADX 18/20) |
| ANKR | LONG | 0.00% | **READY** |
| BAND | LONG | 0.05% | needs 0.1% move; volume below average |
| LINK | SHORT | 0.10% | needs 0.1% move |
| EGLD | SHORT | 0.33% | needs 0.3% move |
| AVAX | SHORT | 0.53% | needs 0.5% move; volume below average |
| DASH | SHORT | 0.70% | needs 0.7% move; volume below average |
| BTC | SHORT | 1.05% | needs 1.0% move |
| COMP | SHORT | 1.06% | needs 1.1% move; volume below average |
| BAT | LONG | 1.31% | needs 1.3% move |
