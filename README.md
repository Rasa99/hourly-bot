...
**Updated 2026-09-13 06:07 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
|---|---|---|---|
| ENJ | LONG | 0.00% | **READY** |
| LTC | LONG | 0.02% | needs 0.0% move; trend too weak (ADX 12/20) |
| QTUM | LONG | 0.72% | needs 0.7% move; RSI already stretched (80/78) |
| ATOM | SHORT | 0.87% | needs 0.9% move; volume below average |
| EGLD | SHORT | 0.93% | needs 0.9% move; volume below average |
| FIL | LONG | 1.52% | needs 1.5% move; trend too weak (ADX 16/20) |
| SUSHI | LONG | 1.66% | needs 1.7% move; trend too weak (ADX 17/20) |
| BTC | SHORT | 1.75% | needs 1.8% move; trend too weak (ADX 6/20) |
| CELO | LONG | 1.98% | needs 2.0% move; volume below average |
| COMP | SHORT | 2.01% | needs 2.0% move; trend too weak (ADX 12/20) |
