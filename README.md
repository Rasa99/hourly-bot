...
**Updated 2026-09-26 14:07 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
| | |
|---|---|
| **Equity now** | **$20.4529** 🟢 +2.26% |
| Settled balance | $20.4136 (+2.07%) |
| Unrealised (open trades) | 🟢 +0.0392 |
...
|---|---|---|---|---|---|---|---|
| **MANA** | LONG 🔺 | 0.09099 | 0.09161 | +0.68% | 🟢 +0.0392 | +5.4% | 3.43% |
| | | | | **total** | **+0.0392** | | |
...
| EGLD | LONG | 0.00% | trend too weak (ADX 17/20) |
| ANKR | LONG | 0.25% | needs 0.2% move |
| FIL | LONG | 0.30% | needs 0.3% move |
| ATOM | LONG | 0.38% | needs 0.4% move; volume below average |
| LINK | LONG | 0.47% | needs 0.5% move |
| CHZ | LONG | 0.96% | needs 1.0% move; trend too weak (ADX 13/20) |
| AAVE | LONG | 1.12% | needs 1.1% move; volume below average |
| IOTA | LONG | 1.17% | needs 1.2% move |
| SAND | LONG | 1.20% | needs 1.2% move |
