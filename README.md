...
**Updated 2026-09-19 17:07 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
|---|---|---|---|
| AVAX | LONG | 0.00% | RSI already stretched (88/78) |
| FIL | LONG | 0.00% | RSI already stretched (80/78) |
| HBAR | LONG | 0.00% | **READY** |
| MANA | LONG | 0.00% | volume below average |
| CHZ | LONG | 0.00% | **READY** |
| ONT | LONG | 0.09% | needs 0.1% move; volume below average |
| BTC | LONG | 0.16% | needs 0.2% move |
| BAND | LONG | 0.20% | needs 0.2% move; volume below average |
| DOGE | LONG | 0.26% | needs 0.3% move; volume below average |
| ENJ | LONG | 0.29% | needs 0.3% move |
