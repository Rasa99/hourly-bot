...
**Updated 2026-09-06 00:07 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
| | |
|---|---|
| **Equity now** | **$20.0697** 🟢 +0.35% |
| Settled balance | $20.0984 (+0.49%) |
| Unrealised (open trades) | 🔴 -0.0287 |
...
|---|---|---|---|---|---|---|---|
| **DOT** | LONG 🔺 | 0.918 | 0.915 | -0.33% | 🔴 -0.0287 | -4.5% | 2.40% |
| | | | | **total** | **-0.0287** | | |
...
|---|---|---|---|
| BAND | LONG | 0.15% | needs 0.2% move |
| GRT | LONG | 0.22% | needs 0.2% move; volume below average |
| ATOM | LONG | 0.51% | needs 0.5% move; volume below average |
| SNX | LONG | 0.60% | needs 0.6% move; volume below average |
| AVAX | LONG | 0.72% | needs 0.7% move; volume below average |
| BAT | LONG | 0.84% | needs 0.8% move; volume below average |
| CHZ | LONG | 0.87% | needs 0.9% move; volume below average |
| APE | LONG | 0.99% | needs 1.0% move; volume below average |
| LTC | LONG | 1.21% | needs 1.2% move; volume below average |
| AAVE | LONG | 1.27% | needs 1.3% move; volume below average |
