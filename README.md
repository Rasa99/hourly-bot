...
**Updated 2026-08-31 07:07 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
| | |
|---|---|
| **Equity now** | **$19.2457** 🔴 -3.77% |
| Settled balance | $18.8169 (-5.92%) |
| Unrealised (open trades) | 🟢 +0.4288 |
...
|---|---|---|---|---|---|---|---|
| **FIL** | SHORT 🔻 | 0.6813 | 0.6757 | -0.82% | 🟢 +0.0520 | +7.3% | 3.57% |
| **SAND** | SHORT 🔻 | 0.03898 | 0.03656 | -6.21% | 🟢 +0.3768 | +53.7% | 7.93% |
| | | | | **total** | **+0.4288** | | |
...
|---|---|---|---|
| SAND | SHORT | 0.98% | needs 1.0% move; volume below average |
| STORJ | SHORT | 1.10% | needs 1.1% move |
| HBAR | SHORT | 1.90% | needs 1.9% move; volume below average |
| ALGO | SHORT | 2.15% | needs 2.1% move; volume below average |
| EGLD | LONG | 2.20% | needs 2.2% move |
| ETC | SHORT | 2.22% | needs 2.2% move; volume below average |
| DOGE | SHORT | 2.33% | needs 2.3% move; volume below average |
| BTC | LONG | 2.44% | needs 2.4% move; volume below average |
| LTC | SHORT | 2.55% | needs 2.6% move; volume below average |
| CELO | LONG | 2.67% | needs 2.7% move; volume below average |
