...
**Updated 2026-09-07 19:10 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
| | |
|---|---|
| **Equity now** | **$20.5012** 🟢 +2.51% |
| Settled balance | $20.4539 (+2.27%) |
| Unrealised (open trades) | 🟢 +0.0473 |
...
|---|---|---|---|---|---|---|---|
| **DOT** | LONG 🔺 | 1.069 | 1.082 | +1.22% | 🟢 +0.0473 | +11.1% | 4.90% |
| | | | | **total** | **+0.0473** | | |
...
|---|---|---|---|
| SAND | LONG | 0.37% | needs 0.4% move; trend too weak (ADX 12/20) |
| AVAX | LONG | 1.14% | needs 1.1% move; volume below average |
| HBAR | LONG | 1.14% | needs 1.1% move; trend too weak (ADX 15/20) |
| SKL | LONG | 1.54% | needs 1.5% move; volume below average |
| BAT | LONG | 1.57% | needs 1.6% move; trend too weak (ADX 18/20) |
| DOT | LONG | 1.65% | needs 1.7% move |
| COMP | LONG | 1.67% | needs 1.7% move; trend too weak (ADX 19/20) |
| ONT | LONG | 1.69% | needs 1.7% move; trend too weak (ADX 13/20) |
| BTC | LONG | 1.76% | needs 1.8% move; volume below average |
| ETH | LONG | 1.81% | needs 1.8% move; trend too weak (ADX 14/20) |
