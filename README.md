...
**Updated 2026-09-07 21:07 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
| | |
|---|---|
| **Equity now** | **$20.4532** 🟢 +2.27% |
| Settled balance | $20.4539 (+2.27%) |
| Unrealised (open trades) | 🔴 -0.0007 |
...
|---|---|---|---|---|---|---|---|
| **DOT** | LONG 🔺 | 1.069 | 1.07 | +0.09% | 🔴 -0.0007 | -0.2% | 3.83% |
| | | | | **total** | **-0.0007** | | |
...
|---|---|---|---|
| ICP | LONG | 0.00% | **READY** |
| COMP | LONG | 0.09% | needs 0.1% move; trend too weak (ADX 17/20) |
| BAT | LONG | 0.74% | needs 0.7% move; trend too weak (ADX 17/20) |
| APE | LONG | 0.79% | needs 0.8% move; trend too weak (ADX 11/20) |
| HBAR | LONG | 0.92% | needs 0.9% move; trend too weak (ADX 14/20) |
| AVAX | LONG | 1.10% | needs 1.1% move; volume below average |
| SKL | LONG | 1.28% | needs 1.3% move |
| AXS | LONG | 1.39% | needs 1.4% move; trend too weak (ADX 13/20) |
| SAND | LONG | 1.65% | needs 1.6% move; trend too weak (ADX 13/20) |
| ETH | LONG | 1.67% | needs 1.7% move; trend too weak (ADX 12/20) |
