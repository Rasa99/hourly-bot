...
**Updated 2026-09-10 19:07 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
| | |
|---|---|
| **Equity now** | **$21.9382** 🟢 +9.69% |
| Settled balance | $22.0379 (+10.19%) |
| Unrealised (open trades) | 🔴 -0.0997 |
...
|---|---|---|---|---|---|---|---|
| **MANA** | SHORT 🔻 | 0.07142 | 0.07206 | +0.90% | 🔴 -0.0997 | -9.9% | 1.17% |
| | | | | **total** | **-0.0997** | | |
...
|---|---|---|---|
| BTC | SHORT | 0.76% | needs 0.8% move; volume below average |
| HBAR | SHORT | 0.90% | needs 0.9% move; volume below average |
| ONT | SHORT | 1.17% | needs 1.2% move; volume below average |
| THETA | SHORT | 1.29% | needs 1.3% move; volume below average |
| SKL | SHORT | 1.37% | needs 1.4% move; volume below average |
| CELO | SHORT | 1.44% | needs 1.4% move |
| BNB | SHORT | 1.48% | needs 1.5% move; volume below average |
| APE | SHORT | 1.55% | needs 1.5% move; volume below average |
| LINK | SHORT | 1.61% | needs 1.6% move; volume below average |
| BCH | SHORT | 2.13% | needs 2.1% move; volume below average |
