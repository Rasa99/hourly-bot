...
**Updated 2026-09-10 22:09 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
| | |
|---|---|
| **Equity now** | **$21.9976** 🟢 +9.99% |
| Settled balance | $22.0379 (+10.19%) |
| Unrealised (open trades) | 🔴 -0.0402 |
...
|---|---|---|---|---|---|---|---|
| **MANA** | SHORT 🔻 | 0.07142 | 0.07164 | +0.31% | 🔴 -0.0402 | -4.0% | 1.76% |
| | | | | **total** | **-0.0402** | | |
...
| LINK | SHORT | 0.84% | needs 0.8% move; volume below average |
| IOTA | SHORT | 0.98% | needs 1.0% move; volume below average |
| APE | SHORT | 1.08% | needs 1.1% move; volume below average |
| CRV | SHORT | 1.09% | needs 1.1% move; volume below average |
| BAND | SHORT | 1.16% | needs 1.2% move; volume below average |
| HBAR | SHORT | 1.34% | needs 1.3% move; volume below average |
| SAND | SHORT | 1.36% | needs 1.4% move; volume below average |
| ADA | SHORT | 1.39% | needs 1.4% move; volume below average |
| BCH | SHORT | 1.39% | needs 1.4% move; volume below average |
