...
**Updated 2026-09-15 08:07 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
| | |
|---|---|
| **Equity now** | **$21.4727** 🟢 +7.36% |
| Settled balance | $21.4058 (+7.03%) |
| Unrealised (open trades) | 🟢 +0.0669 |
...
|---|---|---|---|---|---|---|---|
| **RVN** | SHORT 🔻 | 0.002126 | 0.002106 | -0.94% | 🟢 +0.0669 | +8.4% | 3.61% |
| | | | | **total** | **+0.0669** | | |
