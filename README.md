...
**Updated 2026-09-11 08:10 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
| | |
|---|---|
| **Equity now** | **$22.0676** 🟢 +10.34% |
| Settled balance | $22.0379 (+10.19%) |
| Unrealised (open trades) | 🟢 +0.0297 |
...
|---|---|---|---|---|---|---|---|
| **MANA** | SHORT 🔻 | 0.07142 | 0.07116 | -0.36% | 🟢 +0.0297 | +2.9% | 2.45% |
| | | | | **total** | **+0.0297** | | |
...
| APE | SHORT | 0.66% | needs 0.7% move; volume below average |
| LINK | SHORT | 0.73% | needs 0.7% move; volume below average |
| AVAX | SHORT | 0.98% | needs 1.0% move; volume below average |
| BTC | SHORT | 0.99% | needs 1.0% move; volume below average |
| SKL | SHORT | 1.10% | needs 1.1% move; volume below average |
| BNB | SHORT | 1.44% | needs 1.4% move; volume below average |
| ADA | SHORT | 1.73% | needs 1.7% move; volume below average |
