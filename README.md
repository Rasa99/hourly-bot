...
**Updated 2026-09-21 20:07 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
|---|---|---|---|
| BTC | LONG | 0.00% | RSI already stretched (87/78) |
| ETH | LONG | 0.32% | needs 0.3% move; volume below average |
| SOL | LONG | 0.69% | needs 0.7% move; volume below average |
| QTUM | LONG | 0.89% | needs 0.9% move; trend too weak (ADX 17/20) |
| BAT | LONG | 0.90% | needs 0.9% move; volume below average |
| BNB | LONG | 0.96% | needs 1.0% move; volume below average |
| LINK | LONG | 1.08% | needs 1.1% move; volume below average |
| CRV | LONG | 1.32% | needs 1.3% move; volume below average |
| ATOM | LONG | 1.34% | needs 1.3% move; trend too weak (ADX 13/20) |
| SAND | LONG | 1.37% | needs 1.4% move; volume below average |
