...
**Updated 2026-09-20 01:07 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
|---|---|---|---|
| AVAX | LONG | 0.00% | RSI already stretched (85/78) |
| ETC | LONG | 0.00% | **READY** |
| ALGO | LONG | 0.00% | RSI already stretched (83/78) |
| IOTA | LONG | 0.00% | **READY** |
| ONT | LONG | 0.00% | **READY** |
| SNX | LONG | 0.00% | **READY** |
| ANKR | LONG | 0.00% | volume below average |
| HBAR | LONG | 0.16% | needs 0.2% move; volume below average |
| ENJ | LONG | 0.33% | needs 0.3% move; trend too weak (ADX 19/20) |
| GRT | LONG | 0.34% | needs 0.3% move; volume below average |
