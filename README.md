...
**Updated 2026-09-08 01:07 UTC** &nbsp;·&nbsp; refreshes itself every hour
...
| | |
|---|---|
| **Equity now** | **$20.4368** 🟢 +2.18% |
| Settled balance | $20.4539 (+2.27%) |
| Unrealised (open trades) | 🔴 -0.0171 |
...
|---|---|---|---|---|---|---|---|
| **DOT** | LONG 🔺 | 1.069 | 1.066 | -0.28% | 🔴 -0.0171 | -4.0% | 3.47% |
| | | | | **total** | **-0.0171** | | |
...
|---|---|---|---|
| ALGO | LONG | 0.00% | trend too weak (ADX 14/20) |
| IOTA | LONG | 0.02% | needs 0.0% move; trend too weak (ADX 14/20) |
| ETC | LONG | 0.61% | needs 0.6% move; trend too weak (ADX 16/20) |
| HBAR | LONG | 0.69% | needs 0.7% move; trend too weak (ADX 12/20) |
| BAT | LONG | 0.85% | needs 0.8% move; trend too weak (ADX 15/20) |
| QTUM | LONG | 0.92% | needs 0.9% move; trend too weak (ADX 11/20) |
| AVAX | LONG | 1.00% | needs 1.0% move; volume below average |
| SKL | LONG | 1.02% | needs 1.0% move; volume below average |
| APE | LONG | 1.18% | needs 1.2% move; trend too weak (ADX 10/20) |
| ONT | LONG | 1.33% | needs 1.3% move; trend too weak (ADX 17/20) |
